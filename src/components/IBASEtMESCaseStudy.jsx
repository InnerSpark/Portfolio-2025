          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="aspect-video rounded-2xl overflow-hidden mb-8 border border-neutral-200 relative shadow-sm">
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1, delay: 0.2 }} className="w-full h-full">
                <img src="/img/stock-project-planning.jpg" alt="Project planning board with sticky notes and sprint timeline" className="w-full h-full object-cover" />
              </motion.div>
            </div>
          ...
          <Section id="solution" title="Final Design & Solution" icon={Monitor}>
            ...
            <div className="mb-12">
              ...
              <motion.div whileHover={{ scale: 1.02 }} className="rounded-2xl overflow-hidden border border-neutral-200 shadow-xl bg-white">
                <img src="/img/ibaset-mes-dashboard.png" alt="Dashboard view with card-based layout" loading="lazy" className="w-full h-auto object-cover" />
              </motion.div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <motion.div whileHover={{ scale: 1.02 }} className="rounded-2xl overflow-hidden border border-neutral-200 shadow-lg bg-white">
                  <img src="/img/ibaset-mes-work-order.png" alt="Work order interface for production monitoring" loading="lazy" className="w-full h-auto object-cover" />
                </motion.div>
                <motion.div whileHover={{ scale: 1.02 }} className="rounded-2xl overflow-hidden border border-neutral-200 shadow-lg bg-white">
                  <img src="/img/ibaset-mes-work-order-actions.png" alt="Work order with action buttons and right-side panel" loading="lazy" className="w-full h-auto object-cover" />
                </motion.div>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <motion.div whileHover={{ scale: 1.02 }} className="rounded-2xl overflow-hidden border border-neutral-200 shadow-lg bg-white">
                  <img src="/img/ibaset-mes-work-order-detail.png" alt="Detailed work order screen" loading="lazy" className="w-full h-auto object-cover" />
                </motion.div>
                <motion.div whileHover={{ scale: 1.02 }} className="rounded-2xl overflow-hidden border border-neutral-200 shadow-lg bg-white">
                  <img src="/img/ibaset-mes-work-order-comprehensive.png" alt="Work order detail screen with comprehensive information" loading="lazy" className="w-full h-auto object-cover" />
                </motion.div>
              </div>
            </div>
            ...
            <div>
              ...
              <motion.div whileHover={{ scale: 1.02 }} className="rounded-2xl overflow-hidden border border-neutral-200 shadow-xl bg-white max-w-3xl mx-auto">
                <img src="/img/ibaset-mes-messaging.png" alt="Messaging interface within the platform" loading="lazy" className="w-full h-auto object-cover" />
              </motion.div>
            </div>
          </Section>
